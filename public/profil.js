...
import { getFirestore, collection, getDoc, getDocs, addDoc, updateDoc, doc, setDoc, query, where } from "https://www.gstatic.com/firebasejs/9.8.1/firebase-firestore.js";
    ...
    if (user !== null) {
        ...
        getDoc(doc(db, "users", user.uid)).then(docSnap => {
            ...
            if (docSnap.exists()) {
                ...
                var profil = p.profil;
                getDownloadURL(sRef(storage, profil))
                    .then((url) => {

                        const img = document.getElementById('img_profil');
